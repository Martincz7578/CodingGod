import { playerStats, populationData, demands, incomeHistory, resources } from './economy.js';
...
const saveLoadButton = document.getElementById("save/load") as HTMLButtonElement;
